...
var Video = require('react-native-video').default   //ES5的写法，ES6不知道怎么写
...
var Detail = React.createClass({
  ...
  _setModalVisible(isVisiable) {
    this.setState({
      modalVisible: isVisiable
    })
  },
       ...
       .then((data) => {
         if (data && data.success) {
          ...
          items = [{
            ...
            replyBy: {
              avatar: 'http://dummyimage.com/640 x 640/9d5084',
              nickname: '狗狗说'
            }
          }].concat(items)

          cashedResults.items = items
          cashedResults.total = cashedResults.total + 1
          that.setState({
            isSending: false,
            dataSource: that.state.dataSource.cloneWithRows(cashedResults.items)
          })
      ...
      <View style={styles.container}>
        ...
        <View style={styles.videoBox}>
          <Video 
            ...
            rate={this.state.rate} //取值0~1 , 0暂停
            muted={this.state.muted}   //是否静音 true 静音
            resizeMode={this.state.resizeMode}  //拉伸
        ...
        <Modal 
          ...
          <Button style={styles.sublimitBtn} onPress={this._submit} >评论</Button>
